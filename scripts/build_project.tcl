...
#
# build_project.tcl: Tcl script for re-creating project 'pong'
#
# Generated by Vivado on Sat May 04 19:20:23 -0400 2024
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../hdl/button_debounce.vhd"]"\
 "[file normalize "$origin_dir/../hdl/video_timings_pkg.vhd"]"\
 "[file normalize "$origin_dir/../hdl/pong_game_logic.vhd"]"\
 "[file normalize "$origin_dir/../hdl/top.vhd"]"\
 "[file normalize "$origin_dir/../hdl/xilinx/clk_wiz_0/clk_wiz_0.xci"]"\
 "[file normalize "$origin_dir/../constraints/nexysa7_constraints.xdc"]"\
  ]
  foreach ifile $files {
...
set file "$origin_dir/../hdl/button_debounce.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../hdl/video_timings_pkg.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../hdl/pong_game_logic.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../hdl/xilinx/clk_wiz_0/clk_wiz_0.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "[file normalize "$origin_dir/../constraints/nexysa7_constraints.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../constraints/nexysa7_constraints.xdc"
set file [file normalize $file]
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/../constraints/nexysa7_constraints.xdc"]" -objects $obj
set_property -name "target_part" -value "xc7a100tcsg324-1" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/../constraints/nexysa7_constraints.xdc"]" -objects $obj
